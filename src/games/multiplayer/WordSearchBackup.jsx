...
const WordSearch = () => {
  ...
  // Make initial connection on page load
  useEffect(() => {
  ...
  }, [socket, player1Username, player2Username, words, gridSize, difficulty, grid])
  ...
  const startNewGame = async () => {
    ...
    setIsHost(true)
    socket.emit('createGame', 'wordSearch', newGameId, userInfo.username, difficulty)
  };
...
// }
  ...
  const handleJoinGame = () => {
    console.log('joining: ', gameIdInput)
    if(!gameIdInput){
      alert('Please enter a game ID')
      return
    }
      socket.emit('joinGame', 'wordSearch', gameIdInput, userInfo.username)
  ...
  return (
    <div className="game-container">
      ...
      <div className="game-content">
        ...
        {!player1Username ? (<div className="game-controls">
          <select 
